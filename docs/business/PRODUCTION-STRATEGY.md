...
How to ship BankAI to real users cheaply, run it as an AI-operated bank, and harden it into a
...
`bankai-mcp-test-harness`) that drive the system as a real client. Extend that idea to **ops skills**
